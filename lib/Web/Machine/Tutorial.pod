...
framework to some code that might look like this for C<Web::Machine>:
    ...
    sub content_types_excepted { return [ {'application/json' => 'to_json'} ] }
...
L<GET|Web::Machine::Tutorial::RequestBasics>
...
L<POST/PUT/DELETE|Web::Machine::Tutorial::RequestAdvanced>

=item *

L<Advanced Resources|Web::Machine::Tutorial::Advanced>
